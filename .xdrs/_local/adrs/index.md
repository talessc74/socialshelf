...
- [_local-adr-policy-042-arquitetura-multi-tenant-workspace](application/042-arquitetura-multi-tenant-workspace.md) - **DESCARTADA** — partiu de entendimento incorreto de "multi-usuário" como colaboração em equipe; pedido real era isolamento total entre contas, já coberto pelo modelo existente
